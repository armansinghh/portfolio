...
export default function LatestCommitActivity() {
  const { data, error, isLoading } = useSWR("/api/commits", fetcher, {
  ...
  return (
    <div className="flex flex-col gap-2 h-full justify-center">
      <div className="flex items-center gap-2 flex-wrap">
        <span className="font-mono text-xs font-medium text-blue-600 dark:text-blue-400 bg-blue-500/10 px-1.5 py-0.5 rounded border border-blue-500/20">
          #{shortSha}
        </span>
